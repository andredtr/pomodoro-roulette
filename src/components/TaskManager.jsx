...
function TaskManager({ tasks, onAddTask, onDeleteTask }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h2 className="text-xl font-bold mb-4 text-gray-800">Task Manager</h2>
      ...
      <div className="space-y-2">
        <h3 className="font-semibold text-gray-700 mb-2">Tasks ({tasks.length})</h3>
        {tasks.length === 0 ? (
          <p className="text-gray-500 italic">No tasks yet. Add some tasks to get started!</p>
        ) : (
